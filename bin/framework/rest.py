...
def splunkd_request(
    ...
    for _ in range(retry):
        try:
            ...
            resp = requests.request(  # nosemgrep: splunk.disabled-cert-validation, python.requests.security.disabled-cert-validation.disabled-cert-validation, python.requests.best-practice.use-raise-for-status.use-raise-for-status, gitlab.bandit.B501, contrib.dlint.dlint-equivalent.insecure-requests-use  # noqa: E501
                method,
                splunkd_uri,
                headers=headers,
                data=data,
